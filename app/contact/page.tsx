...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    'Tell us the problem. A 15-minute call or a paragraph — both land in the same inbox. Valencia, CA · +1 (661) 488-0808.',
  openGraph: {
...
export default function ContactPage() {
  const localBusinessLd = buildLocalBusinessJsonLd(SITE_URL)
  return (
    <>
